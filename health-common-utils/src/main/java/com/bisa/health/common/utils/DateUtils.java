...
public abstract class DateUtils {
	...
	public static String getFormatEnDateTime(String time) {
		...
		/*
		 * DateFormat longDF =
		 * DateFormat.getDateTimeInstance(SimpleDateFormat.LONG,SimpleDateFormat.LONG,
		 * Locale.US); System.out.println("long模式的时间：" + longDF.format(date));
		 * //November 10, 2017 11:03:46 AM CST
		 */
